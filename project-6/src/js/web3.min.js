                ...
                (i.prototype.isType = function (t) {
                    ...
                    (i.prototype.decode = function (t, e, n) {
                        ...
                        if (this.isDynamicArray(n))
                            return (function () {
                                for (
                                    var o = parseInt("0x" + t.substr(2 * e, 64)), i = parseInt("0x" + t.substr(2 * o, 64)), a = o + 32, s = r.nestedName(n), c = r.staticPartLength(s), u = 32 * Math.floor((c + 31) / 32), f = [], l = 0;
                                    l < i * u;
                                    l += u
                                )
                                        ...
                                        if (!this._nRounds || this._keyPriorReset !== this._key) {
                                            for (var t = (this._keyPriorReset = this._key), e = t.words, n = t.sigBytes / 4, r = (this._nRounds = n + 6), o = 4 * (r + 1), a = (this._keySchedule = []), s = 0; s < o; s++)
                                                if (s < n) a[s] = e[s];
                                                    ...
                                                    var c = a[s - 1];
                                                    s % n
                                                        ? n > 6 && s % n == 4 && (c = (i[c >>> 24] << 24) | (i[(c >>> 16) & 255] << 16) | (i[(c >>> 8) & 255] << 8) | i[255 & c])
                                                        : ((c = (c << 8) | (c >>> 24)), (c = (i[c >>> 24] << 24) | (i[(c >>> 16) & 255] << 16) | (i[(c >>> 8) & 255] << 8) | i[255 & c]), (c ^= m[(s / n) | 0] << 24)),
                                                        (a[s] = a[s - n] ^ c);
                                                }
                    ...
                    return (
                        (function (e) {
                            ...
                            !(function () {
                                ...
                                for (var r = 2, o = 0; o < 64; ) t(r) && (o < 8 && (s[o] = n(e.pow(r, 0.5))), (c[o] = n(e.pow(r, 1 / 3))), o++), r++;
                            })();
                            var u = [],
                                f = (a.SHA256 = i.extend({
                                    _doReset: function () {
                                    ...
                                    _doFinalize: function () {
                                        var t = this._data,
                                            ...
                                            o = 8 * t.sigBytes;
                                        return (
                                            (n[o >>> 5] |= 128 << (24 - (o % 32))), (n[(((o + 64) >>> 9) << 4) + 14] = e.floor(r / 4294967296)), (n[(((o + 64) >>> 9) << 4) + 15] = r), (t.sigBytes = 4 * n.length), this._process(), this._hash
                                        );
                                    },
                                    clone: function () {
                                        var t = i.clone.call(this);
                ...
                !(function (t) {
                    ...
                    function n(t) {
                        function e(t, n) {
                            ...
                            for (
                                (o = c.indexOf(".")) > -1 && (c = c.replace(".", "")), (i = c.search(/e/i)) > 0 ? (o < 0 && (o = i), (o += +c.slice(i + 1)), (c = c.substring(0, i))) : o < 0 && (o = c.length), i = 0;
                                48 === c.charCodeAt(i);
                                i++
                            );
                        ...
                        function p(t, n, r, i) {
                            ...
                            for (
                                ...
                                m >= 0 && ((u = $), ($ = 0), (t = t.replace(".", "")), (d = new e(r)), (p = d.pow(t.length - m)), ($ = u), (d.c = c(f(o(p.c), p.e), 10, n)), (d.e = d.c.length)),
                                    h = c(t, r, n),
                                    s = u = h.length;
                                0 == h[--u];
                                h.pop()
                            ...
                            if (!h[0]) return "0";
                            if (
                                (m < 0 ? --s : ((p.c = h), (p.e = s), (p.s = i), (p = T(p, d, y, g, n)), (h = p.c), (l = p.r), (s = p.e)),
                                    (a = s + y + 1),
                                    (m = h[a]),
                                    (u = n / 2),
                                    (l = l || a < 0 || null != h[a + 1]),
                                    (l = g < 4 ? (null != m || l) && (0 == g || g == (p.s < 0 ? 3 : 2)) : m > u || (m == u && (4 == g || l || (6 == g && 1 & h[a - 1]) || g == (p.s < 0 ? 8 : 7)))),
                                a < 1 || !h[0])
                            )
                                t = l ? f("1", -y) : "0";
                            else {
                                ...
                                t: {
                                    ...
                                    if (
                                        ((r = r || e < 0 || null != l[u + 1] || (a < 0 ? c : c % p[o - a - 1])),
                                            (r = n < 4 ? (f || r) && (0 == n || n == (t.s < 0 ? 3 : 2)) : f > 5 || (5 == f && (4 == n || r || (6 == n && (i > 0 ? (a > 0 ? c / p[o - a] : 0) : l[u - 1]) % 10 & 1) || n == (t.s < 0 ? 8 : 7)))),
                                        e < 1 || !l[0])
                                    )
                                ...
                                (e.config = e.set = function () {
                                    ...
                                    return (
                                        ...
                                        c((e = "EXPONENTIAL_AT")) && (s(t) ? W(t[0], -S, 0, 2, e) && W(t[1], 0, S, 2, e) && ((j = 0 | t[0]), (q = 0 | t[1])) : W(t, -S, S, 2, e) && (j = -(q = 0 | (t < 0 ? -t : t)))),
                                            (r[e] = [j, q]),
                                        c((e = "RANGE")) &&
                                        (s(t) ? W(t[0], -S, -1, 2, e) && W(t[1], 1, S, 2, e) && ((z = 0 | t[0]), (L = 0 | t[1])) : W(t, -S, S, 2, e) && (0 | t ? (z = -(L = 0 | (t < 0 ? -t : t))) : U && O(2, e + " cannot be zero", t))),
                                            (r[e] = [z, L]),
                                        ...
                                        (t === !0 || t === !1 || 1 === t || 0 === t
                                            ? t
                                                ? ((t = "undefined" == typeof crypto), !t && crypto && (crypto.getRandomValues || crypto.randomBytes) ? (J = !0) : U ? O(2, "crypto unavailable", t ? void 0 : crypto) : (J = !1))
                                                : (J = !1)
                                            : U && O(2, e + y, t)),
                                            (r[e] = J),
                                        ...
                                        if (((t = null != t && W(t, 0, S, 14) ? 0 | t : M), (a = d(t / w)), J))
                                            if (crypto.getRandomValues) {
                                                ...
                                                for (r = crypto.randomBytes((a *= 7)); c < a; )
                                                    (s = 281474976710656 * (31 & r[c]) + 1099511627776 * r[c + 1] + 4294967296 * r[c + 2] + 16777216 * r[c + 3] + (r[c + 4] << 16) + (r[c + 5] << 8) + r[c + 6]),
                                ...
                                (T = (function () {
                                    ...
                                    return function (i, a, s, c, u) {
                                        ...
                                        if ((D[p] > (T[p] || 0) && l--, O < 0)) b.push(1), (h = !0);
                                            ...
                                            for (
                                                C = T.length, F = D.length, p = 0, O += 2, d = m(u / (D[0] + 1)), d > 1 && ((D = t(D, d, u)), (T = t(T, d, u)), (F = D.length), (C = T.length)), S = F, x = T.slice(0, F), k = x.length;
                                                k < F;
                                                x[k++] = 0
                                            );
                                    ...
                                    return (
                                        (R = 11),
                                            ...
                                            !i.c || !t.s || (t.c && !t.c[0])
                                                ...
                                                : !t.c || (i.c && !i.c[0])
                                                    ? new e(i)
                                                    : (9 == G ? ((o = t.s), (t.s = 1), (r = T(i, t, 0, 3)), (t.s = o), (r.s *= o)) : (r = T(i, t, 0, G)), i.minus(r.times(t)))
                                    );
                                }),
                                        ...
                                        ((f = Math.sqrt(+c)),
                                            0 == f || f == 1 / 0
                                                ...
                                                (n.length + l) % 2 == 0 && (n += "0"),
                                                    (f = Math.sqrt(n)),
                                                    (l = r((l + 1) / 2) - (l < 0 || l % 2)),
                                                    f == 1 / 0 ? (n = "1e" + l) : ((n = f.toExponential()), (n = n.slice(0, n.indexOf("e") + 1) + l)),
                                                    (i = new e(n)))
                                                : (i = new e(f + "")),
                                            i.c[0])
                                    )
                                ...
                                (E.toFraction = function (t) {
                                    ...
                                    if (
                                        ...
                                        ((U = !1),
                                            (c = new e(t)),
                                            (U = p),
                                        ((p = c.isInt()) && !c.lt(P)) || (U && O(22, "max denominator " + (p ? "out of range" : "not an integer"), t), (t = !p && c.c && N(c, c.e + 1, 1).gte(P) ? c : null))),
                                            !d)
                                    )
                                        return h.toString();
                                    for (
                                        l = o(d), a = m.e = l.length - h.e - 1, m.c[0] = k[(s = a % w) < 0 ? w + s : s], t = !t || c.cmp(m) > 0 ? (a > 0 ? m : y) : c, s = L, L = 1 / 0, c = new e(l), u.c[0] = 0;
                                    ...
                                    return (
                                        null === i
                                            ? r
                                                ? ((e = "Infinity"), r < 0 && (e = "-" + e))
                                                : (e = "NaN")
                                            : ((e = o(n.c)), (e = null != t && W(t, 2, 64, 25, "base") ? p(f(e, i), 0 | t, 10, r) : i <= j || i >= q ? u(e, i) : f(e, i)), r < 0 && n.c[0] && (e = "-" + e)),
                                            e
                                    );
                                }),
